...
export default {
  ...
  methods: {
    ...
    getCategory() {
      this.$axios
        .post("http://47.100.75.161:8081/product/getCategory", {})
        .then(res => {
          const val = {
            categoryId: 0,
            categoryName: "全部"
    ...
    getData() {
      ...
      const api =
        this.categoryID.length == 0
          ? "http://47.100.75.161:8081/product/getAllProducts"
          : "http://47.100.75.161:8081/product/getProductsByCategory";
      this.$axios
        .get(api, {
          params:{
        ...
        .then(res => {
          this.product = res.data.result.products;

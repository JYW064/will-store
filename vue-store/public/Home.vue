...
export default {
  ...
  created() {
    ...
    this.getHot(
      [2, 3, 4],
      "applianceList",
      "http://localhost:8080/index/getHotProducts"
    );
    this.getHot(
      [5 ,6 , 7, 8],
      "accessoryList",
  ...
  methods: {
    ...
    getPromo(categoryId, val, api) {
      api = api != undefined ? api : "http://localhost:8080/index/getPromoProducts";
      this.$axios
        .post(api, {
          categoryId
        })
    ...
    getHot(categoryId, val, api) {
      api = api != undefined ? api : "http://localhost:8080/index/getHotProducts";
      this.$axios
          .post(api, categoryId
          )
          .then(res => {
